...
ROTACIONPTOC
	ADDWF PCL,F
	DT 0X00, B'11100010', B'11100001'
	DT B'11000011',B'10100011',B'01100011'   
END_ROTACIONPTOC	
;===============================================================================		
CONVERT_HEX
	ADDWF PCL,F
...
tklbuena
	...
	MOVWF CORRECTO
	CALL TONOBUENO
	;TRANSMITIR EL VALOR A ENCENDER EN PANTALLA POR EL I2C APAGA LA ANTERIOR
	;SOLO BORRA CUANDO INICIA LAS PREGUNTAS
	BANK0		   
	MOVLW .80
	MOVWF CONTA_3
	CALL RETARDO_20MS
